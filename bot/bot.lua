...
local cernerbkk = msg.content.text
local cernerbkv = msg.content.text
if cerner then
chat_id = msg.chat_id
cerner = cerner:lower()
end
...
if cernerbk == '#bk' then
tdbot.deleteMessages(msg.chat_id,{[0] =msg.id})
tdbot.sendVideoNote(msg.chat_id,msg.reply_to_message_id or msg.id ,'./BK.gif','06')
end
if cernerbk == '#bkk' then
tdbot.deleteMessages(msg.chat_id,{[0] =msg.id})
tdbot.sendVideoNote(msg.chat_id,msg.reply_to_message_id or msg.id ,'./BKK.gif','06')
end
if cernerbkv == '#bkv' then
tdbot.deleteMessages(msg.chat_id,{[0] =msg.id})
tdbot.sendVoice(msg.chat_id,msg.reply_to_message_id or msg.id ,'./BK.ogg','BK :|')
end
